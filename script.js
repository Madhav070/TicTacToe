...
function checkWinner() {
  for (let i = 0; i <= 6; i = i + 3) {
    if (
      btn[i].textContent == btn[i + 1].textContent &&
      btn[i + 1].textContent == btn[i + 2].textContent &&
      (btn[i].textContent == "X" || btn[i].textContent == "O")
    ) {
      return true;
    }
  }
  for (let i = 0; i < 3; i++) {
    if (
      btn[i].textContent == btn[i + 3].textContent &&
      btn[i + 3].textContent == btn[i + 6].textContent &&
      (btn[i].textContent == "X" || btn[i].textContent == "O")
    ) {
      return true;
    }
  ...
  if (
    ...
    (btn[0].textContent == "X" || btn[0].textContent == "O")
  ) {
    return true;
  }
  if (
    ...
    (btn[2].textContent == "X" || btn[2].textContent == "O")
  ) {
    return true;
  }
  return false;
